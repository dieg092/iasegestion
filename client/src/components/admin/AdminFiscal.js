        ...
        <div className="row">
          <div className="col s12 margin-top-20">
            ...
            <div className="col s12">
              ...
              <button onClick={() => {this.props.newTax(this.props.history)}} href="/admin/fiscal-financiero/nuevo-impuesto" className="col s12 m3 margin-right-12 waves-effect white grey-text text-darken-4 btn-large right margin-top-20 no-padding-x">SUBIR IMPUESTO</button>
            </div>
