...
class Post extends Component {
  ...
  renderPhoto() {
    return (
      <div className="margin-bottom-75 margin-top-42-negative min-height-photo" style={{ backgroundImage: 'url(https://s3.eu-west-3.amazonaws.com/iase-test/' + this.props.postSelected.mainPhoto + ')', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: height }}>
