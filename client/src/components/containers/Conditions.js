        ...
        <div className="container">
          <div className="row">
            <div className="col s12">
              <h2 className="font-35-custom">INFORMACIÓN RELEVANTE</h2>
              ...
              <h2 className="font-35-custom">LICENCIA</h2>
              <p>IASE Gestión  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>


              <h2 className="font-35-custom">USO NO AUTORIZADO</h2>
              ...
              <h2 className="font-35-custom">PROPIEDAD</h2>
              ...
              <h2 className="font-35-custom">POLÍTICA DE REEMBOLSO Y GARANTÍA</h2>
              ...
              <ul className="collection">
                <li className="collection-item">De acuerdo a las especificaciones técnicas indicadas para cada producto.</li>
                <li className="collection-item">En condiciones ambientales acorde con las especificaciones indicadas por el fabricante.</li>
                <li className="collection-item">En uso específico para la función con que fue diseñado de fábrica.</li>
                <li className="collection-item">En condiciones de operación eléctricas acorde con las especificaciones y tolerancias indicadas.</li>
              </ul>

              <h2 className="font-35-custom">COMPROBACIÓN ANTIFRAUDE</h2>
              ...
              <p>IASE Gestión reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
            </div>
          </div>
        </div>
        <Footer />
